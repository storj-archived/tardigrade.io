...
$(function(){
  ...
  $(function(){
    $('#drilldown-6').on('hide.bs.collapse', function () {
      $('#jm-plus-6').removeClass("glyphicon-minus").addClass("glyphicon-plus");
    });
    $('#drilldown-6').on('show.bs.collapse', function () {
      $('#jm-plus-6').removeClass("glyphicon-plus").addClass("glyphicon-minus");
    });
  });

  $(function(){
    $('#drilldown-7').on('hide.bs.collapse', function () {
      $('#jm-plus-7').removeClass("glyphicon-minus").addClass("glyphicon-plus");
    });
    $('#drilldown-7').on('show.bs.collapse', function () {
      $('#jm-plus-7').removeClass("glyphicon-plus").addClass("glyphicon-minus");
    });
  });

  $(function(){
    $('#drilldown-8').on('hide.bs.collapse', function () {
      $('#jm-plus-8').removeClass("glyphicon-minus").addClass("glyphicon-plus");
    });
    $('#drilldown-8').on('show.bs.collapse', function () {
      $('#jm-plus-8').removeClass("glyphicon-plus").addClass("glyphicon-minus");
    });
  });
